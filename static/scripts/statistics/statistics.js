...
function onMessageArrived(msg) { // 매개변수 msg는 도착한 MQTT 메시지를 담고 있는 객체
  try {
    ...
    document.getElementById('velocity').innerHTML = (velocitySum / dataArr.length).toFixed(2) + "km/h";
    document.getElementById('passing_time').innerHTML = (passTimeSum / dataArr.length).toFixed(2) + "초";
